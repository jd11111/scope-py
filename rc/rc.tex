...
The CARE is:
\begin{equation*}
	\Pi^2 \mathcal{B}^2 - 2 \Pi^2 \mathcal{A}^2 - \mathcal{C}^2 =0.
\end{equation*}
...
\begin{equation*}
	u (t) = - \mathcal{B} \Pi \exp ( t (\mathcal{A}- \mathcal{B}^2 \Pi)) x_0 = -\sqrt{\frac{1}{1-C^2}}  \exp \bigg( - t/\tau - t R\sqrt{\frac{1}{1-C^2}}\bigg) x_0
\end{equation*}
\end{document}
